...
echo " "
echo " "
echo -e "$red                             ➡$cyan [1️] Metasploit install"
echo -e "$red                             ➡$cyan [2️] Metasploit repair"
echo -e "$red                             ➡$cyan [3️] Metasploit backup"
echo -e "$red                             ➡$cyan [4️] Metasploit restore"
echo -e "$red                             ➡$cyan [5️] Metasploit delete"
